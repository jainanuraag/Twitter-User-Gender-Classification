...
# Driver for classification program
# Takes a path to dataset as a csv file
def driver(data):
    # Extract data
...
print(driver("/Users/anuraagjain/Documents/github/B351/B351-Group-7-Final-Project/gender-classifier-DFE-791531.csv"))
